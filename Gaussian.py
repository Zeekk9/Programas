...
ax.plot_surface(X, Y, I0, cmap='jet')
ax = fig.add_subplot(142, projection='3d')
ax.plot_surface(X, Y, I1, cmap='jet')
ax = fig.add_subplot(143, projection='3d')
ax.plot_surface(X, Y, I2, cmap='jet')
ax = fig.add_subplot(144, projection='3d')
ax.plot_surface(X, Y, I3, cmap='jet')
plt.show()
...
plt.grid()
plt.subplot(122)
plt.imshow(phi_unwrap, cmap='jet')
plt.grid()
plt.show()
